 ...
 * @author José Lopes
 */
public class TestePerformance30000 {
    ...
    //povoa a ArrayList com números aleatórios até 30.000
    long_inicio = System.currentTimeMillis();
    
    for(i=0; i<30000; i++){
    Math.random();
    int n = (int) (Math.random() * 30001);
    valores.add(i,n);
    }
    ...
    System.out.printf("O tempo levado para povoar a arraylist com 30000 elementos (em milisegundos: %f)\n", long_fim-long_inicio);
    
    //consulta se um número aleatório até 60000 existe na lista 
    Math.random();
    int valor_consulta = (int) (Math.random()*60001);
    ...
    System.out.printf("O tempo levado para consultar a arraylist de 30000 elementos (em milisegundos: %f)\n", long_fim2-long_inicio2);
